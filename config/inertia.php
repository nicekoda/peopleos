...
return [
    ...
    */
    ...
    'pages' => [
        ...
        // Corrected from the package default (resource_path('js/pages'),
        // lowercase) — this project's actual page directory is
        // resources/js/Pages (capital P), the convention every checkpoint
        // since Checkpoint 16 has used. Never surfaced locally on
        // Windows/NTFS (case-insensitive), but on a case-sensitive
        // filesystem (Linux, incl. GitHub Actions) the lowercase path
        // matches nothing, so the view-finder finds zero pages and every
        // assertInertia() page-existence check fails with "Inertia page
        // component file [...] does not exist" — found via the first
        // real GitHub Actions CI run (Checkpoint 30). See docs/testing.md.
        'paths' => [
