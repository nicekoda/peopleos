...
- HR Documents & Letter Generation (Checkpoint 34) has no DOCX file, e-signature, approval workflow before a letter is final, automated sending, template versioning, bulk generation, or employee self-service download. PDF download was added in Checkpoint 35 — generated on demand, never stored on disk.
